# -*- coding: utf-8 -*-
#
# qsipost  documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath("../qsipost"))
...
version = qsipost.__version__
# The full version, including alpha/beta/rc tags.
release = qsipost.__version__
...
linkcode_resolve = make_linkcode_resolve(
    "qsipost",
    (
        "https://github.com/pennlinc/qsipost/blob/"
...
# sphinxcontrib-bibtex
# -----------------------------------------------------------------------------
bibtex_bibfiles = ["../qsipost/data/boilerplate.bib"]
bibtex_style = "unsrt"
