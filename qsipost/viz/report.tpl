...
<div id="boilerplate">
    ...
    {% if boilerplate %}
    <p>We kindly ask to report results preprocessed with qsipost using the following
       boilerplate</p>
    ...
    {% endif %}
    <p>Alternatively, an interactive <a href="http://qsipost.readthedocs.io/en/latest/citing.html">boilerplate generator</a> is available in the <a href="https://qsipost.org">documentation website</a>.</p>
</div>
