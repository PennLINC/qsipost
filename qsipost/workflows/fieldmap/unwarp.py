...
def init_sdc_unwarp_wf(name="sdc_unwarp_wf"):
    ...
    ants_settings = pkgr.resource_filename("qsipost", "data/fmap-any_registration.json")
    if config.execution.sloppy:
        ants_settings = pkgr.resource_filename(
            "qsipost", "data/fmap-any_registration_testing.json"
        )
...
def init_fmap_unwarp_report_wf(name="fmap_unwarp_report_wf"):
    ...
    .. workflow::
        ...
        from qsipost.workflows.fieldmap.unwarp import init_fmap_unwarp_report_wf
