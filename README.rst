...
.. image:: https://img.shields.io/badge/Source%20Code-pennlinc%2Fqsipost-purple
  :target: https://github.com/PennLINC/qsipost
  :alt: GitHub Repository

.. image:: https://readthedocs.org/projects/qsipost/badge/?version=latest
...
Full documentation at https://qsipost.readthedocs.io

About
-----

``qsipost`` configures pipelines for processing diffusion-weighted MRI (dMRI) data.
...
software packages. We provide a curated set of :ref:`recon_workflows` in ``qsipost``
...
The ``qsipost`` pipeline uses much of the code from ``FMRIPREP``. It is critical
