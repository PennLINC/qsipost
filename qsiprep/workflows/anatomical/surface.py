...
def init_surface_recon_wf(omp_nthreads, hires, name="surface_recon_wf"):
    ...
    See :py:func:`~qsipost.workflows.anatomical.init_autorecon_resume_wf` for details.
    ...
    .. workflow::
        :graph2use: orig
        :simple_form: yes
        from qsipost.workflows.anatomical import init_surface_recon_wf
    ...
    **Subworkflows**
        * :py:func:`~qsipost.workflows.anatomical.init_autorecon_resume_wf`
        * :py:func:`~qsipost.workflows.anatomical.init_gifti_surface_wf`
    """
...
def init_autorecon_resume_wf(omp_nthreads, name="autorecon_resume_wf"):
    ...
    .. workflow::
        :graph2use: orig
        :simple_form: yes
        from qsipost.workflows.anatomical import init_autorecon_resume_wf
...
def init_gifti_surface_wf(name="gifti_surface_wf"):
    ...
    <qsipost.interfaces.NormalizeSurf>` to align with native T1w space.
    .. workflow::
        :graph2use: orig
        :simple_form: yes
        from qsipost.workflows.anatomical import init_gifti_surface_wf
...
def init_segs_to_native_wf(name="segs_to_native", segmentation="aseg"):
    ...
    .. workflow::
        :graph2use: orig
        :simple_form: yes
        from qsipost.workflows.anatomical import init_segs_to_native_wf
...
def _seg2msks(in_file, newpath=None):
    ...
    # if not infant_mode:
    #     ref_img = pkgr("qsipost", "data/mni_1mm_%s_lps.nii.gz" % contrast_name)
    #     ref_img_brain = pkgr("qsipost", "data/mni_1mm_%s_lps_brain.nii.gz" % contrast_name)
    # else:
    #     ref_img = pkgr("qsipost", "data/mni_1mm_%s_lps_infant.nii.gz" % contrast_name)
    #     ref_img_brain = pkgr("qsipost",
