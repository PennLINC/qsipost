...
from qsipost.interfaces.pyafq import PyAFQRecon


def _parse_qsipost_params_dict(params_dict):
...
def init_pyafq_wf(available_anatomical_data, name="afq", qsirecon_suffix="", params={}):
    """Run PyAFQ on some qsipost outputs
    ...
    kwargs = _parse_qsipost_params_dict(params)
