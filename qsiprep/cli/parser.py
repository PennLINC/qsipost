...
#
# Changes made to parse QSIPost cli arguments
#
...
def _build_parser(**kwargs):
    ...
    parser.add_argument(
        "analysis_level",
        choices=["participant"],
        help='Processing stage to be run, only "participant" in the case of ' "QSIPost (for now).",
    )
    ...
    g_perfm.add_argument(
        ...
        type=_to_gb,
        metavar="MEMORY_MB",
        help="Upper bound memory limit for QSIPost processes",
    )
    g_perfm.add_argument(
        "--low-mem",
        action="store_true",
    ...
    g_moco.add_argument(
        ...
        "https://github.com/PennLINC/qsipost/blob/master/qsipost/data/eddy_params.json",
    )
    g_moco.add_argument(
        "--shoreline_iters",
        "--shoreline-iters",
    ...
    g_recon = parser.add_argument_group("Options for reconstructing qsipost outputs")
    ...
    g_recon.add_argument(
        ...
        metavar="PATH",
        type=Path,
        help="use this directory as inputs to qsirecon. This option skips qsipost.",
    )
    g_recon.add_argument(
        ...
        'processed by qsipost. Other options include "ukb" for data processed '
    ...
    g_other.add_argument(
        ...
        "the QSIPost developers. This information helps to "
        "improve QSIPost and provides an indicator of real "
...
def parse_args(args=None, namespace=None):
    ...
    if config.workflow.recon_spec and not config.execution.recon_input:
        ...
        config.execution.recon_input = config.execution.qsipost_dir
    ...
    # Setup directories
    config.execution.log_dir = config.execution.qsipost_dir / "logs"
